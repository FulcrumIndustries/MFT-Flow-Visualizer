const DiagramRenderer = {
    ...
    createFlowRow(flow, flowIndex) {
        ...
        explainBtn.className = 'flow-copy-btn flow-explain-btn flow-action-btn';
        explainBtn.title = 'Explain this flow step by step';
        explainBtn.innerHTML = `<svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
            <circle cx="12" cy="12" r="10"></circle>
            <line x1="12" y1="8" x2="12" y2="12"></line>
            <line x1="12" y1="16" x2="12.01" y2="16"></line>
        </svg><span class="flow-btn-label">Explain</span>`;
        explainBtn.addEventListener('click', (e) => {
            e.stopPropagation();
            UIController.showFlowExplanation(flowIndex, flow);
        });

        rowHeader.appendChild(rowNumber);
        rowHeader.appendChild(copyBtn);
        rowHeader.appendChild(migrationBtn);
        rowHeader.appendChild(explainBtn);
